~ function(){
	...
	function init() {
		...
		for ( var i = 0; i < table.length; i += 5 ) {
			...
			element.style.backgroundImage = 'url("images/small/photo'+ (i/5 + 1) +'.jpeg")';
			// element.style.backgroundSize = 'cover';
			element.title = '宝贝520快乐呀，爱你哟，亲亲～ '+ (i/5 + 1) +'/'+ (table.length/5);
			element.setAttribute('href', 'images/small/photo'+ (i/5 + 1) +'.jpeg');
